...
export default function OfferAndCoupon() {
  return (
      ...
      <div className="mx-auto">
        ...
        <div className="w-[520px] rounded-xl border border-zinc-700 bg-zinc-900 p-10 text-center shadow-lg">
          ...
          <p className="text-sm text-gray-400 max-w-md mx-auto mb-6">
            Offer and Coupon module is under development. We are working to
            bring a simple and effective offer and coupon experience — check
            back soon!
          </p>
