...
function Earningweek() {
  const data = [
    { month: "week1,May", totalAppointments: 25, totalAmount: "12,500", paid: "10,000", notPaid: "2,500" },
    { month: "Week2,May", totalAppointments: 33, totalAmount: "11,200", paid: "9,500", notPaid: "1,700" },
    { month: "Week3,May", totalAppointments: 36, totalAmount: "13,800", paid: "12,000", notPaid: "1,800" },
    { month: "Week4,May", totalAppointments: 25, totalAmount: "12,000", paid: "10,500", notPaid: "1,500" },
    { month: "Week5,May", totalAppointments: 25, totalAmount: "14,500", paid: "13,000", notPaid: "1,500" },
  ...
  return (
    <div className="p-10 w-300 pl-50 mx-auto text-gray-800 shadow-xl">
      ...
      <p className="text-[#D3AF37] mb-6 text-sm">View your weekly earnings summary</p>
